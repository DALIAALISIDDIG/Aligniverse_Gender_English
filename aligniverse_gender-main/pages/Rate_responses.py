...
with st.form(key = "form_rating", clear_on_submit= True):
    try:
        ...
        # Add attention check question
        attention_check2 = st.radio("Please select 'Agree' if you are reading this carefully.", options=["strongly agree", "agree", "neutral", "disagree", "strongly disagree"], horizontal=True, index=None, key="key_attention_check2")
